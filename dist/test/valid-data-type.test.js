...
describe("valid-data-type", () => {
    ...
    it("type-date", utils_1.assertValidSchema("type-date", "MyObject"));
    it("type-date-annotation", utils_1.assertValidSchema("type-date", "MyObject", "basic"));
    it("type-regexp", utils_1.assertValidSchema("type-regexp", "MyObject"));
    ...
    it("type-union-discriminated-mixed-types", utils_1.assertValidSchema("type-union-discriminated-mixed-types", "Shape"));
    ...
    it("type-intersection-union-primitive", utils_1.assertValidSchema("type-intersection-union", "MyObject"));
    ...
    it("type-typeof-object-property", utils_1.assertValidSchema("type-typeof-object-property", "MyType"));
    ...
    it("type-keys", utils_1.assertValidSchema("type-typeof-keys", "MyType"));
    ...
    it("type-indexed-access-type-union", utils_1.assertValidSchema("type-indexed-access-type-union", "MyType"));
