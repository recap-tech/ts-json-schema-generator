...
const DiscriminatedTypeFormatter_1 = require("../src/TypeFormatter/DiscriminatedTypeFormatter");
function createFormatter(config) {
    ...
    chainTypeFormatter
        ...
        .addTypeFormatter(new DiscriminatedTypeFormatter_1.DiscriminatedTypeFormatter(circularReferenceTypeFormatter))
